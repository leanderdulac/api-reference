...
**Atenção!**
1. Você deve validar os postbacks para garantir que eles foram enviados pela Pagar.me.
...
2. *O formato usado para enviar o POSTback é:* `application/x-www-form-urlencoded`
...
---              | ---       | ---
`object`         | `String`  | Nome do tipo do objeto. <br /> **valores possíveis** `transaction`
`old_status`     | `String`  | Status anterior desta transação. <br /> **valores possíveis** `processing`, `authorized`, `waiting_payment`, `pending_refund`
`fingerprint`    | `String`  | **Deprecado**
`event`          | `String`  | Nome do evento. <br /> **valores possíveis** `transaction_status_changed`
`current_status` | `String`  | Status atual da transação. <br /> **valores possíveis** `authorized`, `paid`, `refunded`, `waiting_payment`, `pending_refund`, `refused`
`desired_status` | `String`  | Status desejado desta transação se todo o fluxo for respeitado. <br /> **valores possíveis** `paid`
`id`             | `Integer` | Id da transação
`transaction`    | `Object`  | Objeto contendo informações da transação

#### Exemplo da resposta de um POSTback já formatado
...
transaction[card][holder_name]: example
id: 487720
...
Retorna um POSTback específico relacionado a uma transação.

Parâmetro | Tipo | Descrição
---|---|---
`api_key` <br /> **Obrigatório** | `String` | Chave da API, disponível em seu dashboard
`id` <br /> **Obrigatório** | `String` | Id do POSTback
`transaction_id` <br /> **Obrigatório** | `Integer` | Id da transação
...
Retorna todos os POSTbacks enviados relacionados a uma transação.

Parâmetro | Tpo | Descrição
---|---|---
`api_key` <br /> **Obrigatório** | `String` | Chave da API, disponivel em seu dashboard
`transaction_id` <br /> **Obrigatório** | `Integer` | Id da transação
...
---|---|---
`api_key` <br /> **Obrigatório** | `String` | Chave da API, disponivel em seu dashboard 
`id` <br /> **Obrigatório** | Id do POSTback
`transaction_id` <br /> **Obrigatório** | Id da transação
...
Propriedade      | Tipo      | Descrição
---              | ---       | ---
`object`         | `String`  | Nome do tipo do objeto. <br /> **valores possíveis** `subscription`
`old_status`     | `String`  | Status anterior desta assinatura. <br /> **valores possíveis** `trialing`, `unpaid`, `paid`, `pending_paymenti`
`fingerprint`    | `String`  | **Deprecado**
`event`          | `String`  | Nome do evento. <br /> **valores possíveis** `subscription_status_changed`
`current_status` | `String`  | Status atual da assinatura. <br /> **valores possíveis** `trialing`, `unpaid`, `paid`, `pending_payment`, `canceled`, `ended`
`desired_status` | `String`  | Status desejado desta assinatura se todo o fluxo for respeitado. <br /> **valores possíveis** `paid`
...
subscription[customer][name]: example
...
subscription[customer][email]: example@example.com
...
Parâmetro | Tipo | Descrição
---|---|---
`api_key` <br /> **Obrigatório** | `String` | Chave da API, disponpivel em sua dashboard
`id` <br /> **Obrigatório** | `Integer` | Id do POSTback
`subscription_id` <br /> **Obrigatório** | Id da assinatura
...
Parâmetro | Tipo | Descrição
---|---|---
`api_key` <br /> **Obrigatório** | `String` | Chave de API, disponivel em seu dashboard
`id` <br /> **Obrigatório** | `String` | Id do POSTback
`subscription_id` <br /> **Obrigatório** | `Integer`| Id da assinatura

```endpoint
POST /subscriptions/{subscription_id}/postbacks/{id}/redeliver
```
